...
export const CARD_LABELS: Record<string, string> = {
    ...
    SPELL_COMBATTENTI: 'Lista Combattenti',
...
const SPELL_CARDS = ['SPELL_SCUOLE', 'SPELL_SOTTOSCUOLE', 'SPELL_DESCRITTORI', 'SPELL_CLASSI_DOMINI', 'SPELL_COMPONENTI', 'SPELL_COMBATTENTI']
const LIVELLO_CARDS = [
