...
.atk-card { border: 1px solid var(--hairline); border-radius: .5rem; padding: .5rem; display: grid; gap: .5rem; }
...
.danni-wrap {
  display: grid; gap: .35rem; padding: .5rem; border: 1px dashed var(--hairline); border-radius: .5rem;
