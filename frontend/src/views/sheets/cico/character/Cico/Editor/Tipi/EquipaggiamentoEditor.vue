...
const CAMPI: CampoLabel[] = [
  ...
  // NON è la taglia fisica dell'oggetto (quella è "Taglia oggetto", sotto "Info Oggetto"): questo
  // campo, se impostato, SOSTITUISCE la taglia di chi lo indossa (es. equipaggiamento magico).
