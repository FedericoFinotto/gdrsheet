...
VALUES ('Changeling', 'RAZZA'::tipo_item, 'Changeling', 1, 1, NULL),
       ...
       ('Maledizione del fucile Ammazzadivinita', 'MALEDIZIONE'::tipo_item, 'Maledizione del fucile Ammazzadivinita',
        NULL, 1, 1),
       ('Olfatto Acuto', 'ABILITA'::tipo_item,
        ...
        null, 1, 1),
       ('Armatura in cuoio borchiato (naturale)', 'EQUIPAGGIAMENTO'::tipo_item, 'Armatura', 1, 1, 1),
       ('Scudo in legno', 'EQUIPAGGIAMENTO'::tipo_item, 'Scudo', 1, 1, 1),
       ('FromCompendio', 'ALTRO'::tipo_item, 'FromCompendio', 1, 1, 1),
       ('Tantoo', 'ARMA'::tipo_item, 'Tantoo', null, 1, 1),
       ('Veste del druido', 'EQUIPAGGIAMENTO'::tipo_item, 'Veste del druido', null, 1, 1),
       ('Anello Camaleonte', 'EQUIPAGGIAMENTO'::tipo_item, 'Anello Camaleonte', null, 1, 1),
       ('Anello Camminare sull''acqua', 'EQUIPAGGIAMENTO'::tipo_item, 'Anello Camminare sull''acqua', null, 1, 1),
       ('Sassolino ritornante', 'OGGETTO'::tipo_item, 'Sassolino ritornante', 1, 1, 1),
       ('Extra Wild Shape', 'TALENTO'::tipo_item, '+2 Utilizzi della forma selvaggia', null, 1, 1),
       ('Forma Selvatica Veloce', 'TALENTO'::tipo_item, 'Puoi trasformarti in forma selvaggia con azione veloce', null,
        1, 1),
       ('Senso della natura', 'ABILITA'::tipo_item, 'Bonus di +2 alle prove di Conoscenze (natura) e Sopravvivenza',
        null, 1, 1),
       ('Empatia Selvatica', 'ABILITA'::tipo_item,
        ...
        null, 1, 1),
       ('Andatura nel bosco', 'ABILITA'::tipo_item,
       ...
       ('Forma Selvatica', 'ABILITA'::tipo_item,
        ...
        null, 1, 1),
       ('Compagno animale', 'ABILITA'::tipo_item,
        ...
        null, 1, 1),
       ('Attacco', 'ATTACCO'::tipo_item, null, null, 1, 1);
;
...
VALUES (3, 'AB12', '-4', true, 'VALORE'::tipo_modificatore),
       ...
       (4, 'CO10', +4, true, 'RANK'::tipo_modificatore),    -- CONOSCENZE NATURA
...
--        Armatura
       (12, 'AB1', -1, true, null, 'VALORE'::tipo_modificatore),
-- (12, '', -1, true, null, 'VALORE'::tipo_modificatore), ARRAMPICARSI
       (12, 'AB7', -1, true, null, 'VALORE'::tipo_modificatore),
       (12, 'AB19', -1, true, null, 'VALORE'::tipo_modificatore),
       (12, 'AB21', -1, true, null, 'VALORE'::tipo_modificatore),
       (12, 'AB30', -1, true, null, 'VALORE'::tipo_modificatore),
       (12, 'AB28', -1, true, null, 'VALORE'::tipo_modificatore),
       (12, 'CA', +4, true, null, 'CA_ARMOR'::tipo_modificatore),
--        Scudo
       (13, 'AB1', -1, true, null, 'VALORE'::tipo_modificatore),
-- (12, '', -1, true, null, 'VALORE'::tipo_modificatore), ARRAMPICARSI
       (13, 'AB7', -1, true, null, 'VALORE'::tipo_modificatore),
       (13, 'AB19', -1, true, null, 'VALORE'::tipo_modificatore),
       (13, 'AB21', -1, true, null, 'VALORE'::tipo_modificatore),
       (13, 'AB30', -1, true, null, 'VALORE'::tipo_modificatore),
       (13, 'AB28', -1, true, null, 'VALORE'::tipo_modificatore),
       (13, 'CA', +1, true, null, 'CA_SHIELD'::tipo_modificatore),
       (22, 'CO10', +2, true, null, 'VALORE'::tipo_modificatore),
       (22, 'AB32', +2, true, null, 'VALORE'::tipo_modificatore),
       (26, 'TMP', +4, false, 'contro le capacità magiche dei folletti', 'VALORE'::tipo_modificatore),
       (26, 'RFL', +4, false, 'contro le capacità magiche dei folletti', 'VALORE'::tipo_modificatore),
       (26, 'VLT', +4, false, 'contro le capacità magiche dei folletti', 'VALORE'::tipo_modificatore);
;
